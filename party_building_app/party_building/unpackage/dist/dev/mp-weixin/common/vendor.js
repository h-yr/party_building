...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__A24670F",
    appName: "party_building",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
const pages = [
  {
    ...
    style: {
      navigationBarTitleText: "主题实践活动"
    }
  },
  {
    path: "pages/user_login/login-withpwd",
    style: {
  ...
  {
    path: "pages/cgjq/cgjq",
    style: {
      navigationBarTitleText: "创岗建区",
      enablePullDownRefresh: false
    }
  },
  {
    path: "pages/dnpp/dnpp",
    style: {
      navigationBarTitleText: "党内品牌",
      enablePullDownRefresh: false
    }
  },
  {
    path: "pages/swjs/swjs",
    style: {
      navigationBarTitleText: "三无竞赛",
      enablePullDownRefresh: false
    }
  }
];
...
const S = true, b = "mp-weixin", A = I([]), P = b, T = I('{\n    "address": [\n        "127.0.0.1",\n        "192.168.205.1",\n        "192.168.6.1",\n        "192.168.50.16"\n    ],\n    "debugPort": 9000,\n    "initialLaunchType": "local",\n    "servePort": 7000,\n    "skipFiles": [\n        "<node_internals>/**",\n        "E:/安装文件/HBuilder X/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), C = I('[{"provider":"aliyun","spaceName":"party-building","spaceId":"mp-780c75b2-93e7-442d-839c-0c1a4463f537","clientSecret":"Cj72dkwZcikaDxpFhTtnfw==","endpoint":"https://api.next.bspapp.com"}]') || [];
let O = "";
try {
  O = "__UNI__A24670F";
} catch (e2) {
